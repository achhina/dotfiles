...
function M.setup()
	...
	vim.keymap.set("n", "<leader>dbc", M.breakpoints.set_conditional_breakpoint, { desc = "Debug: Conditional Breakpoint" })
	vim.keymap.set("n", "<leader>dbl", M.breakpoints.set_log_point, { desc = "Debug: Log Point" })
	vim.keymap.set("n", "<leader>dbg", M.breakpoints.create_breakpoint_group, { desc = "Debug: Create Breakpoint Group" })
	...
	-- User commands
	vim.api.nvim_create_user_command("DapEditVar", M.inline_edit.edit_variable, { desc = "Edit variable during debugging" })
	vim.api.nvim_create_user_command("DapEval", M.inline_edit.evaluate_expression, { desc = "Evaluate expression" })
	vim.api.nvim_create_user_command("DapSaveWorkspace", M.session.auto_save_workspace, { desc = "Save debug workspace" })
	vim.api.nvim_create_user_command("DapRestoreWorkspace", M.session.restore_workspace, { desc = "Restore debug workspace" })
end
